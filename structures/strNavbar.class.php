...
class strNavbar{
	 ...
	 * @return boolean
	 */
	public function __construct($title='',$class="navbar-default"){
		$this->title=$title;
		$this->class=$class;
		$this->current_nav=0;
	 ...
	 * @return boolean
	 */
	public function addElement($label,$url="#",$enabled=true,$class='',$style='',$tags='',$target="_self"){
