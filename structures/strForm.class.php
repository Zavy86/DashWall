...
class strForm{
	 ...
	 * @return boolean
	 */
	public function __construct($action,$method="POST",$class='',$id=null){
	 ...
	 * @return boolean
	 */
	public function addField($typology,$name='',$label='',$value='',$placeholder='',$size=10,$class='',$style='',$tags='',$enabled=true){
	 ...
	 * @return boolean
	 */
	public function addFieldAddonButton($url,$label,$class='',$style='',$tags='',$enabled=true){
	 ...
	 * @return boolean
	 */
	public function addFieldOption($value,$label,$class='',$style='',$tags='',$enabled=true){
	 ...
	 * @return boolean
	 */
	public function addControl($typology,$label,$url='',$class='',$confirm='',$style='',$tags='',$enabled=true){
	 ...
	 */
	public function render($scaleFactor=0,$indentations=0){
		// check parameters
		...
		foreach($this->fields_array as $field){
			...
			// input addons
			if(isset($field->addon_prepend)||isset($field->addon_append)||isset($field->addon_button->url)){
		...
		if(isset($this->controls_array) && count($this->controls_array)){
			...
			foreach($this->controls_array as $control_id=>$control){
				// make control tags
				if($control->typology=="button"){$button_id="_".$control_id;}else{$button_id=null;}
