 ...
 */
 ...
 $dashboard.=str_repeat(" ",6).api_link("admin.php?mod=plugins",api_icon("puzzle-piece",null,"fa-4x")."<br><br>Plugins","Manage plugins","btn btn-default btn-lg btn-dashboard")."\n";
