...
checkAuthorizations();
// get object
$schedule_obj=new Schedule(($_REQUEST['idSchedule']??null));
// include template
...
if(is_array($schedule_obj->parameters_array) && count($schedule_obj->parameters_array)){$parameters_text=stripslashes(json_encode($schedule_obj->parameters_array,JSON_PRETTY_PRINT));}else{$parameters_text=null;}
